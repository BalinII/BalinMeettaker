...
export const Audio = ({
  ...
  const { selectedSttProvider, minutesmithApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(minutesmithApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          minutesmithApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
