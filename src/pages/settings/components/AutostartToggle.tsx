  ...
  return (
    <div id="autostart" className={`space-y-2 ${className}`}>
      <Header
        ...
        description="Automatically open MinuteSmith when your system starts"
        isMainTitle
      />
        ...
        <div className="flex items-center space-x-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {isEnabled
                ? "MinuteSmith will launch automatically on system startup"
                : "MinuteSmith will not launch automatically"}
            </p>
          </div>
        </div>
        <Switch
